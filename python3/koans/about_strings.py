...
class AboutStrings(Koan):
    ...
    def test_double_quoted_strings_are_strings(self):
        #assigning/setting/defining a variable, as in "assigning string to a value" or "setting a value to variable" two equal signs means equal; one equal sign means assign
        string = "Hello, world."
        #self.assertEqual or "calling the method assertEqual"
